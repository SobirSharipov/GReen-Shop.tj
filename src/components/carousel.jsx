            ...
            <div className='flex flex-col md:flex-row justify-around items-center bg-gradient-to-r from-[#E8F5E9] via-[#C8E6C9] to-[#A5D6A7] rounded-2xl p-6 md:p-12 relative overflow-hidden min-h-[400px] md:min-h-auto'>
                ...
                <div className='w-full md:w-[40%] relative z-10 text-center md:text-left mb-6 md:mb-0'>
                    <TextType
                        ...
                        typingSpeed={75}
                        className=' text-xs md:text-xl text-[#46A358] font-medium uppercase tracking-wider mb-2' style={{ fontFamily: 'Inter-Medium, sans-serif' }}
                        pauseDuration={1500}
                        showCursor={true}
                        cursorCharacter="|"
                    />
                    <p className='font-bold text-3xl md:text-5xl lg:text-6xl mb-3 md:mb-4 text-gray-800 leading-tight' style={{ fontFamily: 'Montserrat-Bold, sans-serif' }}>
                        LET'S MAKE A<br />
                        BETTER <span className='text-[#46A358]' style={{ fontFamily: 'Montserrat-Bold, sans-serif' }}>PLANET</span>
                    </p>
                    <p className='text-gray-500 text-xs md:text-sm font-light mb-4 md:mb-6 leading-relaxed px-2 md:px-0' style={{ fontFamily: 'Inter-Light, sans-serif' }}>
                        We are an online plant shop offering a wide range
                    </p>
                    <Link to={'/Shop'}>
                        <button className='text-[#46A358] font-bold text-sm md:text-base hover:text-[#3a8a47] transition-colors flex items-center gap-2 bg-transparent border-none p-0 mx-auto md:mx-0' style={{ fontFamily: 'Inter-Bold, sans-serif' }}>
                            SHOP NOW
